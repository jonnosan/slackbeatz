"""``candy drum_and_bass`` — atmospheric texture + build sweeps."""
...
@register_generator("candy", "drum_and_bass")
class CandyDrumAndBass(Generator):
    def generate(self, ctx: PartContext) -> Iterator[Event]:
        ...
        for i in range(n):
            ...
            value = int(round(40 + 60 * lfo * depth * intensity))
            yield CC(
