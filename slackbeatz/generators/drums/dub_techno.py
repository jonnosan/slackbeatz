"""``drums dub_techno`` — locked minimal kit: kick on quarters + closed hat.

No snare, no clap, no fills. The chords gen carries the off-beat
energy; the drums gen just lays a steady 4/4 floor under it.
"""
...
@register_generator("drums", "dub_techno")
class DrumsDubTechno(Generator):
